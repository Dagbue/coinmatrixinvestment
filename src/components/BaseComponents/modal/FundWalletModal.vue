  ...
  <div>
    ...
    <dialog open>
      <div class="alpha">
        ...
        <div class="second-part">
          ...
          <p class="text-3">Note: After making your deposit,kindly send a screenshot/proof of deposit to
            <span class="note-span">
              <a href="mailto:support@coinmatrixinvestment.com" class="para-last">support@coinmatrixinvestment.com</a>
          ...
          <div v-if="this.selectedItem === 'bitcoin' ">
            ...
            <p class="text-5">Wallet Address: bc1qz6qj07tgp0hqyny64pxzz27f00tf2fn2ay5hne</p>
          </div>

          <div v-if="this.selectedItem === 'ethereum' ">
            <p class="text-4">Wallet Name: {{selectedItem}}</p>
            <p class="text-5">Wallet Address: 0xEc93F39D2464F642aA0E5d3C4a0737D60933059d</p>
          </div>
        ...
        <button v-if="this.selectedItem === 'bitcoin' " @click="copyToClipboard('bc1qz6qj07tgp0hqyny64pxzz27f00tf2fn2ay5hne')">Copy</button>

        <button v-if="this.selectedItem === 'ethereum' " @click="copyToClipboard('0xEc93F39D2464F642aA0E5d3C4a0737D60933059d')">Copy</button>

        <button v-if="this.selectedItem === 'USDT' " @click="copyToClipboard('0xEc93F39D2464F642aA0E5d3C4a0737D60933059d')">Copy</button>
